                    ...
                    <tr>
                        ...
                        <td scope="col" width="50%" class="iEntry">
                            ...
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    <input type="checkbox" checked="checked" id="report" name="report" value="1">
                                    <span class="checkbox-custom rectangular"></span>
                            ...
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    <input type="checkbox" checked="checked" id="next_visit" name="next_visit" value="1">
                                    <span class="checkbox-custom rectangular"></span>
                            ...
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    <input type="checkbox" id="search" name="search" value="1">
                                    <span class="checkbox-custom rectangular"></span>
                            ...
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    <input type="checkbox" id="xray_material" name="xray_material" value="1">
                                    <span class="checkbox-custom rectangular"></span>
