                    ...
                    <tr>
                        ...
                        <td scope="col" width="50%" class="iEntry">
                            ...
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    <input type="checkbox" disabled = "disabled" <?php if($record->report == 1){echo "checked";}?> id="report" name="report" value="1">
                                    <span class="checkbox-custom rectangular"></span>
                                    <span class='clabel' style="top:4px"><?=$this->lang->line('report')?> </span>
                                </label>
                            </div>
                            ...
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    ...
                                    <span class="checkbox-custom rectangular"></span>
                                    <span class='clabel' style="top:4px"><?=$this->lang->line('remains')?> </span>
                                </label>
                            </div>
                            
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    <input type="checkbox" disabled = "disabled" <?php if($record->next_visit == 1){echo "checked";}?> id="next_visit" name="next_visit" value="1">
                                    <span class="checkbox-custom rectangular"></span>
                                    <span class='clabel' style="top:4px"><?=$this->lang->line('next_visit')?> </span>
                                </label>
                            </div>
                            ...
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    ...
                                    <span class="checkbox-custom rectangular"></span>
                                    <span class='clabel' style="top:4px"><?=$this->lang->line('expenses')?> </span>
                                </label>
                            </div>
                            
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    <input type="checkbox" disabled = "disabled" <?php if($record->search == 1){echo "checked";}?> id="search" name="search" value="1">
                                    <span class="checkbox-custom rectangular"></span>
                                    <span class='clabel' style="top:4px"><?=$this->lang->line('xray')?> </span>
                                </label>
                            </div>
                            
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    <input type="checkbox" disabled = "disabled" <?php if($record->xray_material == 1){echo "checked";}?> id="xray_material" name="xray_material" value="1">
                                    <span class="checkbox-custom rectangular"></span>
                                    <span class='clabel' style="top:4px"><?=$this->lang->line('xray_material')?> </span>
                                </label>
                            </div>
                            ...
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    ...
                                    <span class="checkbox-custom rectangular"></span>
                                    <span class='clabel' style="top:4px"><?=$this->lang->line('farmcy')?> </span>
                                </label>
                            </div>
