...
<head>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content page-style-square" style="background:#f1f1f1;"> 
        <center><div align="" style="width:320px;margin-top:5%;border:0.5px solid #ccc">
            <?php
                if($this->session->flashdata('msg')){
                    echo $this->session->flashdata('msg');
                }
            ?>
            <div class="form-group row" align="center" style="padding:0 15px;">
                <img src="<?php echo base_url();?>assets/images/amc.png" class="profpic" style="">
            </div>
