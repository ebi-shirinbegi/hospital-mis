                    ...
                    <tr>
                        ...
                        <td scope="col" width="50%" class="iEntry">
                            ...
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    <input type="checkbox" <?php if($record->report == 1){echo "checked";}?> id="report" name="report" value="1">
                                    <span class="checkbox-custom rectangular"></span>
                            ...
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    <input type="checkbox" <?php if($record->next_visit == 1){echo "checked";}?> id="next_visit" name="next_visit" value="1">
                                    <span class="checkbox-custom rectangular"></span>
                            ...
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    <input type="checkbox" <?php if($record->search == 1){echo "checked";}?> id="search" name="search" value="1">
                                    <span class="checkbox-custom rectangular"></span>
                            ...
                            <div class="checkbox-container btm20margin">
                                <label class="checkbox-label">
                                    <input type="checkbox" <?php if($record->xray_material == 1){echo "checked";}?> id="xray_material" name="xray_material" value="1">
                                    <span class="checkbox-custom rectangular"></span>
