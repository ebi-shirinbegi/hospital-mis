    ...
    <tr>
        <td scope="col" width="33%" class="iEntry">
            <div class="inputfield">
                ...
                <div class="textfield btm20padding">
                    <input id="the_amount" name="the_amount" type="text" placeholder="<?=$this->lang->line('the_amount')?>" class="form-control iInput" value="">     
                </div>
            </div>        
        </td>
        <td scope="col" width="33%" class="iEntry">                
            <div class="inputfield">
                ...
                <div class="textfield btm20padding">
                      <input id="item_price" name="item_price" type="text" placeholder="<?=$this->lang->line('item_price')?>" class="form-control iInput" value=""> 
                </div>
            </div>
        </td>
    </tr>
...
<table class="table"> 
    ...
    <tr>
        <td scope="col" width="100%%" class="iEntry" colspan="3">
            <input type="button" id="singlebutton" name="singlebutton" class="btn btn-success" value="<?=$this->lang->line('search')?>" onclick="submitSearch('<?=base_url()?>index.php/expenses/home/filter','filter','list_div1');">                                            
            ...
            <input type="button" id="singlebutton" name="singlebutton" class="btn btn-success" value="<?=$this->lang->line('print_excel')?>" onclick="do_it2('<?=base_url()?>index.php/expenses/home/genDBexelprint','filter');">
            <?php } ?>
        </td>
    </tr>
</table>
