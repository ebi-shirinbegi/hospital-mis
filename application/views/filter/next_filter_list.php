    ...
    <table class="table table-striped table-bordered table-advance table-hover">
            ...
            <tbody>
                ...
                <tr class="prs">
                    ...
                    <td>
                        <center><input class="btn btn-success" value="<?=$this->lang->line("view");?>" onclick="javascript:bring_page('<?=base_url()?>index.php/next_visit/home/view/<?=$this->clean_encrypt->encode($row->urn);?>','<?=$row->urn;?>')" style="width:110px;"></center> 
                    </td>
                </tr>
                <?php $i++; }} ?>
            </tbody>
