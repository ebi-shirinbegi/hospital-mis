            ...
            <table class="table" style="margin:0">
                ...
                <tr>
                    <td scope="col" width="100%%" class="iEntry" colspan="3">
                        <input type="button" onclick="bring_page('<?=base_url()?>index.php/remains/home/remain_list','')" class="btn btn-default" value="<?=$this->lang->line('back_to_list')?>" >
                        <?php if($record->remains>0 && $record->remains != ""){ ?>
                        <input type="submit" id="singlebutton" name="singlebutton" class="btn btn-success" value="<?=$this->lang->line('pay_remain')?>" onclick="javascript:doit('<?=base_url()?>index.php/remains/home/pay/<?=$this->clean_encrypt->encode($record->urn);?>','')">
                        <?php } ?>
                    </td>
                </tr>
            </table>
