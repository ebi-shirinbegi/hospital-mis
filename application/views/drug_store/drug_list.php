    ...
    <div class="icontent">
        ...
        <div class="queue_date" style="border-bottom:0.5px solid #444;margin-bottom:20px;">
            <div class="textfield btm20padding" style="padding-bottom:10px;">
                <input type="button" id="singlebutton" style="min-width:100px;" name="singlebutton" class="btn btn-success" value="<?=$this->lang->line('drug_add')?>" onclick="bring_page('<?=base_url()?>index.php/drug_store/home/drug_add','')"> 
            </div>
        </div>
        <div class="filterDiv">
                ...
                <table class="table table-striped table-bordered table-advance table-hover">
                        <thead>
                            <tr>
                                ...
                                <th width="20%">
                                    <span><?=$this->lang->line('drugs')?></span>
                                </th>
                                
                                <th width="15%">
                                    <span><?=$this->lang->line('drug_type')?></span>
                                </th>
                                ...
                                <th width="15%">
                                    <span><?=$this->lang->line('buy_price')?></span>                                        
                                </th>
                                
                                <th width="15%">
                                    <span><?=$this->lang->line('sale_price')?></span>                                        
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr class="prs">
                                ...
                                <td>
                                    <center><input class="btn btn-success" value="<?=$this->lang->line("view");?>" onclick="javascript:bring_page('<?=base_url()?>index.php/drug_store/home/view/<?=$this->clean_encrypt->encode($row->urn);?>','<?=$row->urn;?>')" style="width:110px;"></center> 
                                </td>
                            </tr>
                            <?php $i++; }} ?>
                        </tbody>
