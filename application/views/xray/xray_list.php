    ...
    <div class="icontent">
        ...
        <div class="queue_date" style="border-bottom:0.5px solid #444;margin-bottom:20px;">
            <div class="textfield btm20padding" style="padding-bottom:10px;">
                <input type="button" id="singlebutton" style="min-width:100px;" name="singlebutton" class="btn btn-success" value="<?=$this->lang->line('xray_add')?>" onclick="bring_page('<?=base_url()?>index.php/xray/home/xray_add','')">
                
                <input type="button" id="singlebutton" style="min-width:100px;" name="singlebutton" class="btn btn-primary" value="<?=$this->lang->line('xray_add_new')?>" onclick="bring_page('<?=base_url()?>index.php/xray/home/xray_add_new','')"> 
            </div>
        </div>
        <div class="filterDiv">
                ...
                <table class="table table-striped table-bordered table-advance table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="prs">
                                ...
                                <td>
                                    <center><input class="btn btn-success" value="<?=$this->lang->line("view");?>" onclick="javascript:bring_page('<?=base_url()?>index.php/xray/home/view/<?=$this->clean_encrypt->encode($row->urn);?>')" style="width:110px;"></center> 
                                </td>
                            </tr>
                            <?php $i++; }} ?>
                        </tbody>
