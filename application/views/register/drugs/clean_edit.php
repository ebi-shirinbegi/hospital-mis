...
if($teeth_record){
    ...
    foreach($teeth_record as $row){
        if($row->ill_type == 4){
?>
<input type="hidden" class="clean_urn" name="clean_urn" value="<?=$row->urn?>">
        ...
        <div class="textfield btm20padding" style = "background: #ebccd1;padding:3px 8px 5px;">
            <div class="checkbox-container inrow">
                <label class="checkbox-label">
                    <input type="checkbox" <?php if($row->jermgery == 1){echo "checked='checked'";} ?> id="jermgery" name="jermgery" value="1">
            ...
            <div class="checkbox-container inrow">
                <label class="checkbox-label">
                    <input type="checkbox" <?php if($row->bleching == 1){echo "checked='checked'";} ?> id="bleching" name="bleching" value="1">
                    <span class="checkbox-custom rectangular"></span>
