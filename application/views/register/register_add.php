    ...
    <div class="icontent">
        ...
        ?>
            <div class="table-responsive text-nowrap">
                  <input type="hidden" value="<?=$queue_urn?>" name = "queue_urn">  
                  <table class="table">
                    <!-- <thead> -->
                      <tr>
                        <td scope="col" width="33%" class="iEntry profilePic">
                            ...
                            <div class="profile">
                                ...
                                <div class="textfield">
                                    <div class="rLabel">
                                        <label class="col-md-4 control-label fileLabel" for="profile"><?=$this->lang->line('add_profile')?></label>
                                        <br>
                                    </div>
                                    <input id="attachment" name="attachment" class="input-file sprofile" type="file" onchange="readURL(this,'pictureImg')">        
                                </div>
                            </div>
                        </td>
                        <td scope="col" width="33%" class="iEntry">
                            <div class="inputfield">
                                ...
                                <div class="textfield btm20padding">
                                    <input id="name" name="name" type="text" placeholder="<?=$this->lang->line('name')?>" class="form-control iInput" value="<?php if($queue_details){ echo $queue_details->name; }?>">     
                                </div>
                            </div>
                            ...
                            <div class="inputfield">
                                ...
                                <div class="textfield btm20padding">
                                      <input id="f_name" name="f_name" type="text" placeholder="<?=$this->lang->line('f_name')?>" class="form-control iInput" value="<?php if($queue_details){ echo $queue_details->f_name; }?>"> 
                                </div>
                            </div>    
