...
<div class="inputfield" id="cover">
    <div class="inputfield">
        <div class="textfield btm20padding" style = "background: #bce8f1;padding:3px 8px 5px;">
            <div class="checkbox-container inrow">
                <label class="checkbox-label">
                    <input type="checkbox" <?php if($row->partial == 1){echo "checked='checked'";} ?> disabled='disabled' >
            ...
            <div class="checkbox-container inrow">
                <label class="checkbox-label">
                    <input type="checkbox" <?php if($row->complete == 1){echo "checked='checked'";} ?> disabled='disabled' >
                    <span class="checkbox-custom rectangular"></span>
            ...
            <div class="checkbox-container inrow">
                <label class="checkbox-label">
                    <input type="checkbox" <?php if($row->implent == 1){echo "checked='checked'";} ?> disabled='disabled' >
                    <span class="checkbox-custom rectangular"></span>
        ...
        <div class="textfield btm20padding" style = "background: #bce8f1;padding:3px 8px 5px;"> 
            <div class="checkbox-container inrow">
                <label class="checkbox-label">
                    <input type="checkbox" <?php if($row->ccpalete == 1){echo "checked='checked'";} ?> disabled='disabled' >
                    <span class="checkbox-custom rectangular"></span>
            ...
            <div class="checkbox-container inrow">
                <label class="checkbox-label">
                    <input type="checkbox" <?php if($row->full_bredge == 1){echo "checked='checked'";} ?> disabled='disabled' >
                    <span class="checkbox-custom rectangular"></span>
