                ...
                <tr>
                    <td scope="col" width="33%" class="iEntry">
                        <div class="inputfield">
                            ...
                            <div class="textfield btm20padding">
                                  <?=$this->register_model->doctorName($record->doctor);?>
                            </div>
                        </div>
                    </td>
                    <td scope="col" width="33%" class="iEntry">
            ...
            <table class="table" style="margin:0">
                ...
                <tr>
                    <td scope="col" width="100%%" class="iEntry" colspan="3">
                        ...
                        <?php } ?>
                        <input type="button" onclick="bring_page('<?=base_url()?>index.php/next_visit/home/next_visit_list','')" class="btn btn-default" value="<?=$this->lang->line('back_to_list')?>" >
                        
                        <?php
                        //check next visit done
                        if(!$this->amc_auth->isDone($record->patient_id)){
                        ?>
                        <input type="submit" id="singlebutton" name="singlebutton" class="btn btn-primary" value="<?=$this->lang->line('the_next_visit')?>" onclick="javascript:bring_page('<?=base_url()?>index.php/next_visit/home/next_visit/<?=$this->clean_encrypt->encode($record->urn);?>','<?//=$row->urn;?>')"> 
                        <?php } ?>
                        
                        <?php if($record->remains>0 && $record->remains != ""){ ?>
                        <input type="submit" id="singlebutton" name="singlebutton" class="btn btn-success" value="<?=$this->lang->line('pay_remain')?>" onclick="javascript:doit('<?=base_url()?>index.php/next_visit/home/pay/<?=$this->clean_encrypt->encode($record->urn);?>','')">
                        <?php } ?>
                    </td>
                </tr>
            </table>
